...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.console=tty0 selinux=permissive apparmor=1 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 vmalloc=400M utags.blkdev=/dev/block/platform/msm_sdcc.1/by-name/utags androidboot.write_protect=0
